;; This is a modified .emacs originally created by
;; Casey Muratori. I feel his comment below reflects 
;; my experience with LISP as well 
;; 
;; -David 
;; 
...
(setq initial-scratch-message ";; There's a person in my head, scratching to get out.\n")
...
;add keywords to C modes
;(font-lock-add-keywords 'c++-mode
;			'((("\\<\\(internal\\)" 1 font-lock-keyword-face))))
...
(defun casey-big-fun-c-hook () 
  ...
  (defun casey-header-format () 
     ...
     (insert "_H)\n") 
     (insert "/* ========================================================================\n") 
     (insert "   $Creator: David Kirn $\n") 
     (insert "   $Notice: (C) Copyright 2015 by David Kirn All Rights Reserved. $\n") 
     (insert "   ======================================================================== */\n") 
     (insert "\n") 
     (insert "#define ") 
     (push-mark) 
...
; TODO redo compilation, or simply figure it all out and adjust accordingly
; Compilation 
...
;(add-to-list 'default-frame-alist '(font . "DejaVu Sans Mono-10:weight=semi-bold")) 
(add-to-list 'default-frame-alist '(font . "Liberation Mono-10:weight=semi-bold"))
;(add-to-list 'default-frame-alist '(font . "Consolas-11:weight=semi-bold")) 
;(add-to-list 'default-frame-alist '(font . "Lucida Console-13:weight=semi-bold"))
...
;; (set-face-attribute 'font-lock-string-face nil :foreground "steel blue")
...
;; (set-face-attribute 'font-lock-preprocessor-face nil :foreground "spring green")
...
;; (set-face-attribute 'font-lock-keyword-face nil :foreground "white")
;; (set-face-attribute 'font-lock-string-face nil :foreground "steel blue")
;; (set-face-attribute 'font-lock-type-face nil :foreground "medium spring green")
;; (set-face-attribute 'font-lock-variable-name-face nil :foreground "white")
;; (set-face-attribute 'font-lock-constant-face nil :foreground "white")
;; (set-face-attribute 'font-lock-preprocessor-face nil :foreground "medium spring green")
;; (add-to-list 'custom-theme-load-path "~/.emacs.d/themes/") 
...
(set-face-attribute 'font-lock-keyword-face nil :foreground "white")
(set-face-bold-p 'font-lock-keyword-face t)
(set-face-attribute 'font-lock-string-face nil :foreground "gray50")
(set-face-attribute 'font-lock-type-face nil :foreground "spring green")
(set-face-bold-p 'font-lock-type-face t)
(set-face-attribute 'font-lock-variable-name-face nil :foreground "wheat3")
(set-face-attribute 'font-lock-constant-face nil :foreground "medium aquamarine")
(set-face-attribute 'font-lock-preprocessor-face nil :foreground "spring green")
(add-to-list 'custom-theme-load-path "~/.emacs.d/themes/") 
...
;I'm guessing the theme loading messes with the cursor color 
;So I set it again here. 
(set-face-background 'cursor "#40FF40")
